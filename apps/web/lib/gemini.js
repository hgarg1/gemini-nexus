...
export const getGeminiModel = (modelName = "gemini-1.5-flash", apiKey) => {
...
export const extractCheckpointSuggestion = async (prompt, responseText, modelName, apiKey) => {
...
export const generateGeminiResponse = async (prompt, history = [], apiKey, config, image // Base64 data with data:image/... prefix
) => {
